...
import { QuemSomo } from '@/payload-types' // 1. Import the type
          ...
          <div className="flex flex-col justify-center px-6 lg:px-12 xl:px-16 py-16">
            <div className="max-w-md">
              ...
              <div className="space-y-4 mb-8">
                {/* Add a check for hero.description */}
                {hero.description &&
      ...
      <section className="bg-brand-warm py-16 lg:py-20">
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <div className="space-y-6 text-white">
            {/* Add a check for oSopeSection.text */}
            {oSopeSection.text &&
            ...
            {equipaSection.teamMembers &&
              ...
              equipaSection.teamMembers.map((member, index) => (
                <div key={index} className="text-center max-w-sm">
                  ...
                  {/* Team Member Info */}
                  <h3 className="text-xl font-serif font-medium mb-2 text-brand-dark">
                    {member.name}
                  </h3>
